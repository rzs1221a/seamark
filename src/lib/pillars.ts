...
export const capabilitiesLede =
  "Everything below is running — on this page, or a site you can visit.";
...
export const pillars: Pillar[] = [
  {
    ...
    matters:
      "Category is set once and proximity can't be changed at all, which leaves reviews as the one heavily-weighted signal still in your hands. Set up wrong it gets suspended; set up right it follows you between brokerages.",
    proof:
  ...
  },
  {
    ...
    matters:
      "Most searches now end without a click. What still reaches a person is local and high-intent — and it lands on pages like these.",
  ...
  },
  {
    ...
    matters:
      "The site feeds the CRM you already open, instead of becoming a second inbox you forget.",
  ...
  },
  {
    ...
    matters:
      "A site you can't touch goes stale. Yours ships with an editor login, not a retainer.",
